...
public class MenuClients extends Fragment {
    ...
    private void findViews(View view) {
        ...
        removeButton = (LinearLayout) view.findViewById( R.id.removeButton );
        updateButton = (LinearLayout) view.findViewById( R.id.updateButton );
        showAllButton = (LinearLayout) view.findViewById( R.id.showAllButton );

        addButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(getActivity(), AddClientActivity.class);
        ...
        removeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(getActivity(), NotImplementedActivity.class);
                startActivity(myIntent);
            }
        });
        ...
        showAllButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(getActivity(), ClientListActivity.class);
                startActivity(myIntent);
            }
        });
    }
